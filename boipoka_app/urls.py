...
urlpatterns = [
    ...
    path('makeunread/<int:pk>/',views.makeunread, name='makeunread'),
    path('deletenotification/<int:pk>/',views.deletenotifcation, name='deletenotification'),
    ...
    path('send-returned-notifications/<int:pk>/', views.send_returned_notifications, name='send_returned_notifications'),
    path('send-borrowed-notifications/<int:pk>/',views.send_borrowed_notifications,name='send_borrowed_notifications'),
    path('send_payment_needed/<int:pk>/', views.send_payment_needed,name='send_payment_needed'),
    path('send_payment_approval/<int:pk>/', views.send_payment_approval,name='send_payment_approval'),
